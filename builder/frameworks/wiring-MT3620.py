...
def dev_init(env, platform):
    ...
    env.Append(
        ...
        #LIBPATH = [], 
        LDSCRIPT_PATH = join(env.framework_dir, "Sysroots", env.sysroot, "linker_cpp.ld"),              
        LINKFLAGS = [  
            "-mcpu=cortex-m4", "-mfloat-abi=soft", "-march=armv7e-m", "-mthumb", 
            "-nostartfiles", 
            "-Wl,--no-undefined", 
        ...
        #LIBSOURCE_DIRS=[ join(env.framework_dir, "baremetal", "libraries"),  ],     
        LIBS = [ "gcc" ],               
        BUILDERS = dict(
